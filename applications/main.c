 ...
 * Change Logs:
 * Date           Author       email
 * 2020-06-13     XMJYever     liuxy11@mail.ustc.edu.cn
 */
...
int main(void)
{
	...
	/* show RT-Thread logo */
    lcd_show_string(0, 0, 24, "Name: XMJYever");
	lcd_show_string(0, 30, 24, "ID: 19000000");
	
	lcd_set_color(WHITE, RED);
	
    /* show some   on lcd */
    lcd_show_string(0, 60, 24, "Title:Connect OneNet");
    
    /* draw a line on lcd */
    lcd_draw_line(0, 72+24, 240, 72+24);
	
	lcd_set_color(WHITE, BLACK);
	
	/* show some   on lcd */
    lcd_show_string(50, 72+24+5, 32, "RESULT");
	...
	while(1)
	{
        ...
        else
        {
			...
			lcd_show_string(0, 72+24+40, 32, "PS_DATA:");
			lcd_show_num(180, 72+24+40, ps_data, 7, 32);
		}
		
		/* read als data */
        brightness = ap3216c_read_ambient_light(dev);
        rt_kprintf("current brightness: %d.%d(lux) \n", (int)brightness, ((int)(10 * brightness) % 10));
		lcd_show_string(0, 72+24+40+35, 32, "ALS_DATA:");
		lcd_show_num(180, 72+24+40+35, brightness, 7, 32);
